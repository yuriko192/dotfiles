...
hl.workspace_rule({ workspace = "4", monitor = MONITOR2, default = true, persistent = true, layout = scroling })
hl.workspace_rule({ workspace = "5", monitor = MONITOR2, default = false, persistent = true })
